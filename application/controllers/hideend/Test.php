...
class Test extends CI_Controller 
{
	...
	public function index() 
	{
		...
		// Loads HTML page
		$this->template->loadContent("hidepage/test/index.php", array(
			)
		);
	}
	...
	public function restricted_group() 
	{
		...
		// Loads HTML page
		$this->template->loadContent("hidepage/test/group.php", array(
			)
		);
	}
	...
	public function restricted_admin() 
	{
		...
		// Loads HTML page
		$this->template->loadContent("hidepage/test/admin.php", array(
			)
		);
	}
	...
	public function restricted_user() 
	{
		...
		// Loads HTML page
		$this->template->loadContent("hidepage/test/user.php", array(
			)
		);
	}
	...
	public function restricted_premium() 
	{
		...
		// Loads HTML page
		$this->template->loadContent("hidepage/test/premium.php", array(
			)
		);
	}
