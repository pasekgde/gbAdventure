...
class User_Settings extends CI_Controller 
{
	...
	public function index() 
	{
		...
		$this->template->loadContent("hidepage/user_settings/index.php", array(
			"fields" => $fields
			)
		);
	}
	...
	public function pro() 
	{
		...
		redirect(site_url("hideend/user_settings"));
	}


	public function change_password() 
	{
		$this->template->loadContent("hidepage/user_settings/change_password.php", array(
			)
		);
	}
	...
	public function change_password_pro() 
	{
    	...
    	redirect(site_url("hideend/user_settings/change_password"));
	}
