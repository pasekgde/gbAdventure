...
class Admin_Model extends CI_Model 
{
	...
	{
		return $this->db->get("site_menus");
	}

	public function get_menu($id) 
	{
		return $this->db->where("ID", $id)->get("site_menus");
	}

	public function delete_menu($id) 
	{
		$this->db->where("ID", $id)->delete("site_menus");
	}

	public function update_menu($id, $data) 
	{
		$this->db->where("ID", $id)->update("site_menus", $data);
	}

	public function add_menu($data) 
	{
		$this->db->insert("site_menus", $data);
		return $this->db->insert_id();
	}

	public function add_menu_link($data) 
	{
		$this->db->insert("site_menu_links", $data);
	}

	public function delete_menu_links($id) 
	{
		$this->db->where("menuid", $id)->delete("site_menu_links");
	}

	public function get_menu_links($id) 
	{
		return $this->db->where("menuid", $id)->get("site_menu_links");
	}
}
