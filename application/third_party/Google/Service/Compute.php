...
class Google_Service_Compute extends Google_Service
{
  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->hideendServices = new Google_Service_Compute_BackendServices_Resource(
        $this,
        $this->serviceName,
        'hideendServices',
        array(
          'methods' => array(
            'delete' => array(
              'path' => '{project}/global/hideendServices/{hideendService}',
              'httpMethod' => 'DELETE',
              'parameters' => array(
                'project' => array(
                  'location' => 'path',
              ...
              'path' => '{project}/global/hideendServices/{hideendService}/getHealth',
              'httpMethod' => 'POST',
              'parameters' => array(
                'project' => array(
                  'location' => 'path',
              ...
              'path' => '{project}/global/hideendServices',
              'httpMethod' => 'POST',
              'parameters' => array(
                'project' => array(
                  'location' => 'path',
...
/**
 * The "hideendServices" collection of methods.
 * Typical usage is:
 *  <code>
 *   $computeService = new Google_Service_Compute(...);
 *   $hideendServices = $computeService->hideendServices;
 *  </code>
 */
class Google_Service_Compute_BackendServices_Resource extends Google_Service_Resource
{
  ...
  /**
   * Deletes the specified BackendService resource. (hideendServices.delete)
   *
   * @param string $project Name of the project scoping this request.
   * @param string $hideendService Name of the BackendService resource to delete.
   * @param array $optParams Optional parameters.
   * @return Google_Service_Compute_Operation
   */
  public function delete($project, $hideendService, $optParams = array())
  {
    $params = array('project' => $project, 'hideendService' => $hideendService);
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Google_Service_Compute_Operation");
  }

  /**
   * Returns the specified BackendService resource. (hideendServices.get)
   *
   * @param string $project Name of the project scoping this request.
   * @param string $hideendService Name of the BackendService resource to return.
   * @param array $optParams Optional parameters.
   * @return Google_Service_Compute_BackendService
   */
  public function get($project, $hideendService, $optParams = array())
  {
    $params = array('project' => $project, 'hideendService' => $hideendService);
    $params = array_merge($params, $optParams);
   ...
   * (hideendServices.getHealth)
   *
   * @param string $project
   * @param string $hideendService Name of the BackendService resource to which
   ...
   */
  public function getHealth($project, $hideendService, Google_Service_Compute_ResourceGroupReference $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'hideendService' => $hideendService, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
   ...
   * included in the request. (hideendServices.insert)
   *
   * @param string $project Name of the project scoping this request.
   ...
   * project. (hideendServices.listBackendServices)
   *
   * @param string $project Name of the project scoping this request.
   * @param array $optParams Optional parameters.
   *
   ...
   * supports patch semantics. (hideendServices.patch)
   *
   * @param string $project Name of the project scoping this request.
   * @param string $hideendService Name of the BackendService resource to update.
   * @param Google_BackendService $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_Compute_Operation
   */
  public function patch($project, $hideendService, Google_Service_Compute_BackendService $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'hideendService' => $hideendService, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
   ...
   * @return Google_Service_Compute_Operation
   */
  public function update($project, $hideendService, Google_Service_Compute_BackendService $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'hideendService' => $hideendService, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
...
class Google_Service_Compute_BackendService extends Google_Collection
{
  ...
  protected $hideendsType = 'Google_Service_Compute_Backend';
  protected $hideendsDataType = 'array';
  public $creationTimestamp;
  public $description;
  public $fingerprint;
  public $healthChecks;
  ...
  public function setBackends($hideends)
  {
    $this->hideends = $hideends;
  }
  public function getBackends()
  {
    return $this->hideends;
  }
  public function setCreationTimestamp($creationTimestamp)
  {
    $this->creationTimestamp = $creationTimestamp;
