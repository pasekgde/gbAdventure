...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="<?php echo $this->common->theme_custome(); ?>/images/favicon/favicon-16x16.png"/>
    <link rel="shortcut icon" type="image/png" href="<?php echo $this->common->theme_custome(); ?>/images/favicon/favicon-16x16.png"/>
    <title>Bali Greenbike Adventure - Best Adventure Experience in Bali</title>
    ...
    })(window,document,'script','dataLayer','GTM-KR3S8JW');</script>
...
<body class="tour-template-default single single-tour postid-4643 gdlr-core-body tourmaster-body woocommerce-no-js traveltour-body traveltour-body-front traveltour-full  traveltour-with-sticky-navigation gdlr-core-link-to-lightbox">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KR3S8JW"
            ...
            <div class="traveltour-mobile-header-container traveltour-container">
                <div class="traveltour-logo  traveltour-item-pdlr">
                    <div class="traveltour-logo-inner">
                        <a href="<?=base_url()?>"><img src="<?php echo $this->common->theme_custome(); ?>images/logo.png" alt="" /></a>
                    </div>
                </div>
...
<div class="traveltour-mobile-menu"><a class="traveltour-mm-menu-button traveltour-mobile-menu-button traveltour-mobile-button-hamburger-with-border" href="#traveltour-mobile-menu"><i class="fa fa-bars" ></i></a>
                    ...
                    <div class="traveltour-footer-container traveltour-container clearfix">
                        <div class="traveltour-footer-column traveltour-item-pdlr traveltour-column-20">
                            <div id="text-1" class="widget widget_text traveltour-widget">
                                <div class="textwidget"><img src="<?php echo $this->common->theme_custome(); ?>images/logo.png" alt="" /> <span class="gdlr-core-space-shortcode" id="span_fd3f_15"></span> GREENBIKE ADVENTURE organize many range of activities that combine cultural and adventurous experience to ensure you have better insight of this incedible island. <span class="gdlr-core-space-shortcode" id="span_fd3f_16"></span> </div>
                            </div>
                        </div>
                        <div class="traveltour-footer-column traveltour-item-pdlr traveltour-column-20">
                                ...
                                <div class="tourmaster-widget-tour-category">
                                    <div class="tourmaster-tour-category-widget-holder clearfix">
                                        <div class="tourmaster-tour-category-widget tourmaster-item-list  tourmaster-column-20 tourmaster-column-first tourmaster-with-thumbnail">
                                            ...
                                            <div class="tourmaster-tour-category-head">
                                                <div class="tourmaster-tour-category-head-table">
                                                    <h3 class="tourmaster-tour-category-title"><a class="tourmaster-tour-category-head-link" href="<?= $this->common->slug_link("home/tour/1")?>" >Downhill Cycling</a></h3></div>
                                            </div>
                                        </div>
                                        <div class="tourmaster-tour-category-widget tourmaster-item-list  tourmaster-column-20 tourmaster-with-thumbnail">
                                            ...
                                            <div class="tourmaster-tour-category-head">
                                                <div class="tourmaster-tour-category-head-table">
                                                    <h3 class="tourmaster-tour-category-title"><a class="tourmaster-tour-category-head-link" href="<?= $this->common->slug_link("home/tour/7")?>" >Classic Tour</a></h3></div>
                                            </div>
                                        </div>
                                        <div class="tourmaster-tour-category-widget tourmaster-item-list  tourmaster-column-20 tourmaster-with-thumbnail">
                                            ...
                                            <div class="tourmaster-tour-category-head">
                                                <div class="tourmaster-tour-category-head-table">
                                                    <h3 class="tourmaster-tour-category-title"><a class="tourmaster-tour-category-head-link" href="<?= $this->common->slug_link("home/tour/2")?>" >Electric Bike</a></h3></div>
                                            </div>
                                        </div>
    ...
    <script src="<?php echo $this->common->theme_custome(); ?>/plugins/js/vue.js"></script>
    ...
    <script src="<?php echo $this->common->theme_custome(); ?>/plugins/js/date_fns.js"></script>
    <script src="<?php echo $this->common->theme_custome(); ?>/plugins/js/vue-airbnb-style-datepicker.min.js"></script>
    ...
    <script type="text/javascript">
        (function () {
            var options = {
                facebook: "551260538228831", // Facebook page ID
                whatsapp: "+6281931853105", // WhatsApp number 
                email: "greenbike.cyclingtour@gmail.com", 
                call: "+6285101699692", // Call phone number
                company_logo_url: "//storage.whatshelp.io/widget/4a/4a4a/4a4acefe33e6f0bb4fac0d4fcadb3fe4/23518893_1631792283508979_5989167895300055877_n.jpg", // URL of company logo (png, jpg, gif)
