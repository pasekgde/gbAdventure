...
<?php echo form_open(site_url("hideend/admin/edit_custom_field_pro/" . $field->ID), array("class" => "form-horizontal")) ?>
...
<input type="submit" class="btn btn-primary btn-sm form-control" value="<?php echo lang("ctn_371") ?>" />
<?php echo form_close() ?>
</div>
</div>
