...
<ol class="breadcrumb">
  ...
  <li><a href="<?php echo site_url("hideend/admin") ?>"><?php echo lang("ctn_1") ?></a></li>
  <li><a href="<?php echo site_url("hideend/admin/user_roles") ?>"><?php echo lang("ctn_316") ?></a></li>
...
<?php echo form_open(site_url("hideend/admin/edit_user_role_pro/" . $role->ID), array("class" => "form-horizontal")) ?>
...
<hr>
            ...
            <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="checkbox" name="content_manager" value="1" <?php if($role->content_manager) echo "checked" ?>>
                        </div>
            </div>
            <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="checkbox" name="content_worker" value="1" <?php if($role->content_worker) echo "checked" ?>>
                        </div>
            </div>
            <hr>
