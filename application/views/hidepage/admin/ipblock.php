    ...
    <section class="content">
      <div class="row">
        ...
        <div class="pull-right">
          <?php if($this->common->has_permissions(array("admin", "content_manager"), $this->user)) : ?><button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal"><?php echo ("Block IP") ?></button><?php endif; ?>
        </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                <thead>
                <tr>
            <th><?php echo lang("ctn_68") ?></th>
            <th><?php echo lang("ctn_69") ?></th>
            <th><?php echo lang("ctn_70") ?></th>
          ...
          <tr>
                ...
                <td><a href="<?php echo site_url("hideend/admin/delete_ipblock/" . $r->ID) ?>" class="btn btn-danger btn-xs" title="<?php echo lang("ctn_57") ?>"><span class="glyphicon glyphicon-trash"></span></a></td>
            </tr>
          <?php endforeach; ?>
                </tbody>
       ...
       <div class="modal modal-info fade" id="addModal">
        ...
        <h4 class="modal-title" id="myModalLabel"> <?php echo lang("ctn_71") ?></h4>
              ...
              <div class="modal-body" style="    background-color: #ECF0F5 !important; color:black!important">
                 <?php echo form_open_multipart(site_url("hideend/admin/add_ipblock"), array("class" => "form-horizontal")) ?>
        ...
        <input type="submit" class="btn btn-primary" value="<?php echo ("Add IP") ?>">
      <?php echo form_close() ?>
              </div>
            </div>
            <!-- /.modal-content -->
