...
<td>
  ...
  <?php if($r->banned) : ?><span class="user_role_button banned" title="<?php echo lang("ctn_33") ?>" data-placement="bottom" data-toggle="tooltip"><?php echo lang("ctn_33") ?></span><?php endif; ?>
   <?php if($r->content_manager) : ?><span class="user_role_button project" title="<?php echo lang("ctn_397") ?>" data-placement="bottom" data-toggle="tooltip"><?php echo lang("ctn_395") ?></span><?php endif; ?>
    <?php if($r->content_worker) : ?><span class="user_role_button project" title="<?php echo lang("ctn_398") ?>" data-placement="bottom" data-toggle="tooltip"><?php echo lang("ctn_396") ?></span><?php endif; ?>
</td>
<td><a href="<?php echo site_url("hideend/admin/edit_user_role/" . $r->ID) ?>" class="btn btn-warning btn-xs" title="<?php echo lang("ctn_55") ?>"><span class="glyphicon glyphicon-cog"></span></a> <a href="<?php echo site_url("hideend/admin/delete_user_role/" . $r->ID . "/" . $this->security->get_csrf_hash()) ?>" class="btn btn-danger btn-xs" onclick="return confirm('<?php echo lang("ctn_317") ?>')" title="<?php echo lang("ctn_57") ?>"><span class="glyphicon glyphicon-trash"></span></a></td></tr>
<?php endforeach; ?>
</table>
...
<div class="modal fade" id="memberModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php echo form_open(site_url("hideend/add_user_role_pro"), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                        <label for="username-in" class="col-md-4 label-heading"><?php echo lang("ctn_395") ?> <span class="glyphicon glyphicon-question-sign" title="<?php echo lang("ctn_397") ?>"></span></label>
                        <div class="col-md-8">
                            <input type="checkbox" name="content_manager" value="1">
                        </div>
            </div>
            <div class="form-group">
                        <label for="username-in" class="col-md-4 label-heading"><?php echo lang("ctn_396") ?> <span class="glyphicon glyphicon-question-sign" title="<?php echo lang("ctn_398") ?>"></span></label>
                        <div class="col-md-8">
                            <input type="checkbox" name="content_worker" value="1">
                        </div>
            </div>
