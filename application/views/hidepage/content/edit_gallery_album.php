...
<?php echo form_open_multipart(site_url("hideend/content/edit_gallery_album_pro/" . $album->ID), array("class" => "form-horizontal")) ?>
<div class="form-group">
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-9 ui-front">
                    	<img src="<?php echo base_url() ?><?php echo $this->settings->info->upload_path_relative ?>/<?php echo $album->image ?>"><br />
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <textarea name="desc" id="project-description"><?php echo $album->description ?></textarea>
                    </div>
            </div>
