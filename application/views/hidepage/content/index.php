...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
    ...
    <a href="<?php echo site_url("hideend/content/add_page") ?>" class="btn btn-primary btn-sm"><?php echo lang("ctn_400") ?></a>
    </div>
</div>
   ...
   var st = $('#search_type').val();
    var table = $('#content-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("hideend/content/content_page") ?>",
            type : 'GET',
            data : function ( d ) {
