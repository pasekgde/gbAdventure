          ...
          <div class="box">
            <div class="box-header">
				...
				<div class="pull-right">
					<?php if($this->common->has_permissions(array("admin", "content_manager"), $this->user)) : ?><button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal"><?php echo ("Add Categories") ?></button><?php endif; ?>
				</div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"> <?php echo ("Add Categories") ?></h4>
              </div>
              <div class="modal-body" style="    background-color: #ECF0F5 !important; color:black!important">
                 <?php echo form_open_multipart(site_url("hideend/content/add_post_category"), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
              ...
              <div class="modal-footer">
				...
				<input type="submit" class="btn btn-primary" value="<?php echo ("Add Categories") ?>">
			<?php echo form_close() ?>
              </div>
            </div>
            <!-- /.modal-content -->
