        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
				<div class="col-xs-4">
					<h3 class="box-title">All your post list</h3>
				</div>
				<div class="col-xs-7">
          ...
          <li><a href="#" onclick="change_search(5)"><span class="glyphicon glyphicon-ok no-display" id="category-exact"></span> <?php echo lang("ctn_406") ?></a></li></a></li>
				...
				<div class="col-xs-1">	
					<div class="pull-right">
						<a href="<?php echo site_url("hideend/content/add_post") ?>" class="btn btn-primary"><?php echo lang("ctn_491") ?></a>
					</div>
				</div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="content-table" class="table table-bordered table-hover">
                <thead>
                <tr>
					<tr class="table-header"><td><?php echo lang("ctn_430") ?></td><td><?php echo lang("ctn_401") ?></td><td><?php echo lang("ctn_402") ?></td><td><?php echo lang("ctn_406") ?></td><td><?php echo lang("ctn_339") ?></td><td><?php echo lang("ctn_435") ?></td><td style="min-width: 90px"><?php echo lang("ctn_52") ?></td></tr>
                </tr>
                </thead>
                <tbody>
