            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
					...
					<th><?php echo lang("ctn_271") ?></th>
					<th><?php echo lang("ctn_52") ?></th>
                </tr>
                </thead>
                <tbody>
					<?php foreach($sliders->result() as $r) : ?>
  <tr><td><?php echo $r->name ?></td>
  <td><img src="<?php echo base_url() ?><?php echo $this->settings->info->upload_path_relative ?>/<?php echo $r->image."_50x50.".$r->ext_image ?>" class="content-category"></td>
  <td><?php echo $r->description ?></td>
  <td><a href="<?php echo site_url("hideend/content/edit_slider/" . $r->ID) ?>" class="btn btn-warning btn-xs" data-toggle="tooltip" data-placement="bottom" title="<?php echo lang("ctn_55") ?>"><span class="glyphicon glyphicon-cog"></span></a> <a href="<?php echo site_url("hideend/content/delete_slider/" . $r->ID . "/" . $this->security->get_csrf_hash()) ?>" class="btn btn-danger btn-xs" onclick="return confirm('<?php echo lang("ctn_317") ?>')" data-toggle="tooltip" data-placement="bottom" title="<?php echo lang("ctn_57") ?>"><span class="glyphicon glyphicon-trash"></span></a></td></tr>
<?php endforeach; ?>
                </tbody>
