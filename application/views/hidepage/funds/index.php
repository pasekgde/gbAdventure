...
<p class="align-center"><img src="<?php echo base_url() ?>/images/paypal.png"></p>
		...
		<form method="post" action="https://www.paypal.com/cgi-bin/webscr" accept-charset="UTF-8" class="form-inline">
				...
				<input type="hidden" name="notify_url" value="<?php echo site_url("hideend/IPN/process2") ?>" />
				<input type="hidden" name="return" value="<?php echo site_url("hideend/funds") ?>" />
				<input type="hidden" name="cancel_return" value="<?php echo site_url("hideend/funds") ?>" />
				<input type="hidden" name="no_shipping" value="1" />
				<input type="hidden" name="currency_code" value="<?php echo $this->settings->info->paypal_currency ?>"> 
				<input type="hidden" name="no_note" value="1" />
		<div class="input-group col-md-4">
		    <select name="amount" class="form-control">
		    <option value="0.01"><?php echo $this->settings->info->payment_symbol ?>0.01</option>
