 <div class="content-wrapper">
    ...
    <span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
        ...
        <div class="col-xs-2">  
          <div class="pull-right">
            <a href="<?php echo site_url("hideend/content/add_gallery") ?>" class="btn btn-primary"><?php echo ("Add Gallery") ?></a>
          </div>
        </div>
            </div>
            <!-- /.box-header -->
    ...
    <td><?php echo lang("ctn_401") ?></td>
    <td><?php echo lang("ctn_402") ?></td>
    <td><?php echo lang("ctn_435") ?></td>
