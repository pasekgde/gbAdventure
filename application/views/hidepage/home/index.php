              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <ul class="chart-legend clearfix">
                    <li><i class="fa fa-circle-o text-red"></i> Google</li>
                    <li><i class="fa fa-circle-o text-green"></i> <?php echo lang("ctn_242")?></li>
                    <li><i class="fa fa-circle-o text-aqua"></i> Facebook</li>
                    <li><i class="fa fa-circle-o text-gray"></i> Twitter</li>
                  </ul>
                </div>
                <!-- /.col -->
              </div>
