...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_430") ?></td><td><?php echo lang("ctn_401") ?></td><td><?php echo lang("ctn_402") ?></td><td><?php echo lang("ctn_406") ?></td><td><?php echo lang("ctn_339") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#content-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("hideend/page/content_page") ?>",
            type : 'GET',
            data : function ( d ) {
