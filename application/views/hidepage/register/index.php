...
<div class="btn-group">
  <a href="<?php echo site_url("hideend/login/twitter_login") ?>" class="btn btn-default" >
    <img src="<?php echo base_url() ?>images/social/twitter.png" height="20" class='social-icon' />
   Twitter</a>
</div>

<div class="btn-group">
  <a href="<?php echo site_url("hideend/login/facebook_login") ?>" class="btn btn-default" >
    <img src="<?php echo base_url() ?>images/social/facebook.png" height="20" class='social-icon' />
   Facebook</a>
</div>

<div class="btn-group">
  <a href="<?php echo site_url("hideend/login/google_login") ?>" class="btn btn-default" >
...
<?php endif; ?>
		  		...
		  		<p class="decent-margin"><a href="<?php echo site_url("hideend/login") ?>" class="btn btn-success form-control" ><?php echo lang("ctn_223") ?></a></p>
