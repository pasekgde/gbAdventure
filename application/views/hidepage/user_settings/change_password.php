...
<div class="db-header clearfix">
    ...
    <div class="db-header-extra"> <a href="<?php echo site_url("hideend/user_settings/change_password") ?>" class="btn btn-primary btn-sm"><?php echo lang("ctn_225") ?></a>
</div>
</div>

<ol class="breadcrumb">
  <li><a href="<?php echo site_url() ?>"><?php echo lang("ctn_2") ?></a></li>
  <li><a href="<?php echo site_url("hideend/user_settings") ?>"><?php echo lang("ctn_224") ?></a></li>
...
<hr>
	...
	<div class="panel panel-default">
  	...
  	<?php echo form_open(site_url("hideend/user_settings/change_password_pro"), array("class" => "form-horizontal")) ?>
